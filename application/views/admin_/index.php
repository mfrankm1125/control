                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12" style="text-align: center">
                            <select class="form-control" id="selAnio" style="width: 30%">
                                <?php foreach($anios as $i ){ ?>
                                    <option value="<?=$i["anio"]?>"><?=$i["anio"]?></option>
                               <?php }?>
                            </select>
                        </div>
                        <div class="col-lg-12" id="chartMeses" style="height: 250px;">
                            <h4>Cargando....</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12" style="text-align: center">
                            <select class="form-control" id="selAnio2" style="width: 30%">
                                <?php foreach($anios as $i ){ ?>
                                    <option value="<?=$i["anio"]?>"><?=$i["anio"]?></option>
                                <?php }?>
                        ...
                        <div class="col-lg-12" id="chartMesesDolares" style="height: 250px;">
                            <h4>Cargando....</h4>
                        </div>
                    </div>
