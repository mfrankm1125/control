        ...
        <div class="col-xs-12">
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title"  ><b style="font-size: 18px;"><i class="fa fa-address-card"></i>  Clientes</b>  &nbsp; <button class="btn btn-mint btn-sm" id="btnAddNew">Nuevo+</button> </h3>
...
<script type="text/javascript">
    ...
    $(document).on("click","#btnAddNew",function () {
        $("#modalId").modal("show");
        $("#hModalTitle").html("Registrar Cliente");
    ...
    $(document).on("click","#btnSaveForm",function () {
        ...
        $.post(url_base+"cliente/setForm",form,function (data) {
            if(data.status == "ok"){
                refrescar();
    ...
    function eliminar(id) {
        ...
        $.post(url_base+"cliente/delete",{"id":id},function (data) {
            if(data.status == "ok"){
                refrescar();
                alert_success("Correcto");
            }else{
    ...
    function editar(id,data) {
        $("#modalId").modal("show");
        $("#hModalTitle").html("Editar Cliente");
        var tmpForm=_.template($("#tmpForm").html());
        $("#bModalBody").html(tmpForm);

        $("#isEdit").val(1);
        $("#idEdit").val(data.idcliente);
