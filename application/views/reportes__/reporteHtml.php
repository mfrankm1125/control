                        ...
                        <?php foreach($i["dataactpre"] as $ii){ ?>
                            ...
                            $gaActOp=0;
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <td style="text-align: left;width: 10px;padding: 2px;" ><?=($kkk+1)?></td>

                                            <td style="text-align: left;width: 500px;padding: 2px;" ><?= htmlentities($iii["actop"])?></td>
                                            <td style="text-align: right;width: 40px;padding: 2px;" ><?= htmlentities($iii["um"]) ?></td>
                                            <td style="text-align: right;width: 20px;padding: 2px;" ><?=$iii["datagaop"][0]["metax"]?> </td>
                                            <td style="text-align: right;width: 20px;padding: 2px;" > <?= $iii["datagaop"][0]["ejecAll"] ?></td>
                                            <td style="text-align: right;width: 20px;padding: 2px;" ><?=$ga?>%</td>
                                        </tr>
                            ...
                            <?php foreach($ii["dataactop"] as  $valTarea ){
                            ...
                            <div id="chart">
                                ...
                                <ul id="bars">
                                    ...
                                    foreach ($ii["dataactop"]  as $jk => $vk){
                                        $gaini2=$vk ["datagaop"][0]["porcenajeFinalejecAll"]; //porcenajeFinal
