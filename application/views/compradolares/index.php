        ...
        "columns": [
            ...
            {   "sortable": false,
                ...
                "render": function ( data, type, full, meta ) {
                    ...
                    ht+="<b> Total $"+Number(ttcccx).toFixed(2)+" => S/"+Number(ttcpagx).toFixed(2)+"</b>";
  ...
  function editar(id) {
      ...
      $.post(url_base+"compradolares/getDataEdit",{id:id},function (data) {
          if(data.status=="ok" && data.data.length > 0){
              ...
              $("#tasacambiocompra").val(detallecompra[0].tasacambiocompra);
               ...
               $("#cantCompra,#cantCompraIni").val(detallecompra[0].montocompra);
              $("#monedacompra").val(detallecompra[0].idmoneda);
              $("#iddetcompra").val(detallecompra[0].iddetcomprad);

              $("#selprodini").val(detallecompra[0].idpadre);
              $("#tasacambiocompra").attr("readonly","readonly");
              $("#tVentaRef").attr("readonly","readonly");
                getProductosSearch(detallecompra[0].iddetcomprad,detallecompra[0].montocompra,detallecompra[0].tasacambiocompra);
              calcSubTotalPagar();
             //  var tmpAddDetaillEdit=_.template($("#tmpAddDetillEdit").html());
    ...
    $(document).on("change","#selProducto",function () {
        if($(this).val()=="0-0"){
            $("#tasacambiocompra").val("");
            $("#tVentaRef").val("");
            $("#tasacambiocompra").removeAttr("readonly");
            $("#tVentaRef").removeAttr("readonly");
            $("#cantCompra").val("");
            $("#xPagar").val("");
            return 0;
        }
                ...
                <form id="formRegData">
                    ...
                    <div class="panel-body" style="padding-top: 0px;padding-bottom: 10px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group" style="margin-bottom: 0px;"  >
                                    <label class="control-label" title="Precio Compra">Sumar a este stock:</label>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group" style="margin-bottom: 0px;">
                                    ...
                                    <input type="hidden" id="cantCompraIni" value="">
                                    <input type="hidden" id="selprodini" value="">
                                </div>
                            </div>
