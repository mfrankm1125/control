...
<script type="text/template" id="tmpFormRegProd">
    ...
    <form id="formRegProd">
        ...
        <input type="hidden" name="idplancampaniaRegProd" id="idplancampaniaRegProd" value="<%=data.idplancampania%>">
        <div class="col-sm-12 " style="margin-top: 4px;" >
            <div class="form-group">
                ...
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="number" id="areaejecutada" name="areaejecutada" onclick="javascript:this.select();"   value="<%=data.areaejecutada%>" > ha
                </label>
                ...
                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Fecha Siembra:</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="date" id="fechaSiembraEjec" name="fechaSiembraEjec" value="<%=data.fechasiembraejecutada%>" >
                </label>
                ...
                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Fecha Cosecha:</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="date" id="fechaCosechaEjec" name="fechaCosechaEjec" value="<%=data.fechacosechaejecutada%>" >
                </label>
                ...
                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Costo Total:</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="number" id="costoTotalEjec" onclick="javascript:this.select();"  name="costoTotalEjec" style="text-align: right" value="<%= parseFloat(data.cdirecto) + parseFloat(data.cindirecto) %>" >
                </label>

                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Rendimiento (Kg/Ha):</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <%=   parseFloat(data.rendimiento) %>
                </label>
                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Rendimiento (Kg/Ha):</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="number" id="rendimientoEjec" onclick="javascript:this.select();"   name="rendimientoEjec" style="text-align: right" value="<%=parseFloat(data.rendimientoejecutado) %>" >
                </label>
                ...
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <% var pbruto=0;
                       var psemilla=parseFloat(data.pesosemilla)||0;
                       var pconsumo=parseFloat(data.pesoconsumo)||0;
                       var pdescarte=parseFloat(data.pesodescarte)||0
                       var pmerma=parseFloat(data.pesomerma)||0;
                    pbruto=psemilla+pconsumo+pdescarte+pmerma;
                    %>
                    <input type="number" id="pesoBrutoEjec" name="pesoBrutoEjec" class="form-control" style="text-align: right" readonly="readonly" value="<%=pbruto%>" >
                </label>

                <label class="col-md-6 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  > </label>
                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Semilla</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="number" id="semillaEjec" name="semillaEjec" onclick="javascript:this.select();" class="form-control" style="text-align: right" value="<%=psemilla%>"  >
                </label>

                <label class="col-md-6 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  > </label>
                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Consumo</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="number" id="consumoEjec" name="consumoEjec" onclick="javascript:this.select();"  class="form-control" style="text-align: right" value="<%=pconsumo %>"  >
                </label>

                <label class="col-md-6 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  > </label>
                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Descarte</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="number" id="descarteEjec" name="descarteEjec" onclick="javascript:this.select();"  class="form-control" style="text-align: right"  value="<%=pdescarte %>" >
                </label>
                <label class="col-md-6 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  > </label>
                <label class="col-md-2 control-label" style="text-align: right;font-weight: bold;font-size: 14px;"  >Merma</label>
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="number" id="mermaEjec" name="mermaEjec"  onclick="javascript:this.select();"  class="form-control" style="text-align: right"   value="<%=pmerma %>" >
                </label>
                ...
                <label class="col-md-4 control-label" style="text-align: left;font-weight: bold;font-size: 14px;"  >
                    <input type="text" id="observacion" name="observacion" class="form-control" style="" value="<%= data.observacionejecutado %>" >
                </label>
...
<script type="text/javascript">
    ...
    function registrarProd(datax) {
        ...
        getFactoresAdversos();
        $("#selLocalidadEjec").val(datax.idlocalidad);
    }
    ...
    function getFactoresAdversos() {
        $.ajax({
            ...
            async : true,
            dataType:"json",
            url : url_base+"Semillas/getFactoresAdversos",
            success : function(data) {
                $("#divFactoresAdversos").html(tmpFactoresAdversos({data:data}));
                getFactoresAdversosPlan();
            },
    ...
    function getFactoresAdversosPlan(){
        var idplancampaniaRegProd=$("#idplancampaniaRegProd").val();
        $.post(url_base+"Semillas/getFactorAdversoByPlanCampania",{"idplancampaniaRegProd":idplancampaniaRegProd},function (data) {
            console.log(data);
            var inputsCheck=$("input[name='factor[]']");
            var parseData=[];
            $.each(data,function (k,i) {
                parseData[k]=i.idfactoresadversos;
            });

            $.each(inputsCheck,function (k,i) {
              var check=$(i);
              var ifExist=$.inArray(check.val(),parseData);
              if(ifExist != -1 ){
    ...
    //
    $(document).on("keyup","#semillaEjec,#consumoEjec,#descarteEjec,#mermaEjec",function () {
        calCostoTotalEjec();
    });

    function calCostoTotalEjec(){
     var semillaEjec=parseFloat($("#semillaEjec").val())||0;
     var consumoEjec=parseFloat($("#consumoEjec").val())||0;
     var descarteEjec=parseFloat($("#descarteEjec").val())||0;
     var mermaEjec=parseFloat($("#mermaEjec").val())||0;
     var costoTotalEjec=parseFloat(semillaEjec+consumoEjec+descarteEjec+mermaEjec);
     $("#pesoBrutoEjec").val(costoTotalEjec);
    }
