    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="panel-body form-horizontal form-padding" id="formProveedor">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="razonsocial" name="razonsocial"  class="form-control" placeholder="Ejemplo: Comercial NN " />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label"  >Nombre Contacto </label>
                        <div class="col-md-9">
                            <input id="namecontac" name="namecontac"  class="form-control" placeholder="Ejemplo: Miguel Martines " />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="email" name="email"  class="form-control" placeholder="Ejemplo: miguel@hotmail.com" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label"  >Web</label>
                        <div class="col-md-9">
                            <input id="dirweb" name="dirweb"  class="form-control" placeholder="Ejemplo: www.abc.com" />
                        </div>
                    </div>
