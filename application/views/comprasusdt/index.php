...
function dtIni(){
    dtTable=$('#dtTable').DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?= base_url(); ?>comprasusdt/getData",
            "type": "POST"
        },
        "buttons": [
...
$(document).on("keyup","#cantsoles",function () {
  ...
  $(document).on("click","#btnSaveForm",function () {
      ...
      $.post(url_base+"comprasusdt/setForm",form,function (data) {
         if(data.status == "ok"){
             refrescar();
  ...
  function eliminar(id) {
      ...
      $.post(url_base+"comprasusdt/delete",{"id":id},function (data) {
          if(data.status == "ok"){
              refrescar();
              alert_success("Correcto");
  ...
  function editar(id) {
      ...
      $.post(url_base+"comprasusdt/getDataEdit",{id:id},function (data) {
    ...
    $(document).on("click","#btnSaveFormProv",function () {
        ...
        $.post(url_base+"comprasusdt/setFormProv",form,function (data) {
            if(data.status == "ok"){
                refrescar();
                alert_success("Correcto");
                ...
                <form id="formRegData">
                    ...
                    <div class="panel-body" style="padding-top: 0px;padding-bottom: 10px;">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group" style="margin-bottom: 0px;"  >
                                    <label class="control-label" title="Precio Compra">Precio Compra USDT</label>
                                    <input type="text" id="pcbtc" name="pcbtc" class="form-control" value="0">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group" style="margin-bottom: 0px;">
                                    <label class="control-label">Cant USDT</label>
