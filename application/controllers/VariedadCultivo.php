...
class VariedadCultivo extends CMS_Controller {
    private $_list_perm;
    public $forecast;
    public $val = 0;
    public $acpadres;
    private $table="variedadcultivo";
    private $pk_idtable="idvariedadcultivo";
    ...
    public function index(){
        ...
        $this->template->renderizar('variedadcultivo/index');
    }
