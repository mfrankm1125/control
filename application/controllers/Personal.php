...
class Personal extends CMS_Controller {
    private $_list_perm;
    public $forecast;
    public $val = 0;
    public $acpadres;
    ...
    public function index(){
        ...
        $this->template->renderizar('personal/index');
    }
    ...
    public function setForm(){
        ...
        if(sizeof($this->input->post()) > 0){
            ...
            if( $isEdit == 1 ){
                ...
                $condicion=array('id_personal'=>$idEdit,'usercrea'=>$this->getUserId());
    ...
    public function deleteData(){
        if(sizeof($this->input->post()) > 0){
            ...
            $condicion=array('id_personal'=>$id,'usercrea'=>$this->getUserId());
            $dataD=array(
