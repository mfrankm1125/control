            ...
            if( $isEdit == 0 ){
                ...
                if($concepto == 1 || $concepto ==  5){
                    if($moneda == "1"){
                        ...
                        $ddddxxxxx=explode("-",$post["selProducto"]);
                        ...
                        $detCompra=array(
                            ...
                            "estado"=>1,
                            "isvisible"=>1,
                            "idpadre"=>$post["selProducto"]

                        );

                        if($post["selProducto"] == 0){
                            ...
                            $this->db->set("montocompra", "montocompra+ (".$monto.")"   , FALSE);
        ...
        if(sizeof($post) > 0){
            ...
            if($tabla == "cajad" ){
                ...
                if($moneda=="dol"){
                    ...
                    $montoquita=floatval($post['montoquita']);
                    $this->db->set("montocompra", "montocompra-".$montoquita , FALSE);
                    $this->db->where('idcomprad',$idref);
                    $this->db->update('detcomprad'); // gives UPDATE mytable SET field = field+1 WHERE id = 2
