...
class Categoriacultivo extends CMS_Controller {
    private $_list_perm;
    public $forecast;
    public $val = 0;
    public $acpadres;
    private $table="categoriacultivo";
    private $pk_idtable="idcategoriacultivo";
    ...
    public function index(){
        ...
        $this->template->renderizar('categoriacultivo/index');
    }
