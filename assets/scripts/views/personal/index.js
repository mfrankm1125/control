 ...
 */
var titles={'addtitle':"Agregar Personal" ,'updatetitle':"Editar Personal"};
var isEdit=null,idEdit=null;
$(document).ready(function () {

    var rowSelection = $('#tabla_grid').DataTable({
        "ajax": url_base+'personal/getDataTable',
        "columns": [
            { "data": null },
...
function btnSave(id){
    ...
    if(bol){
        ...
        $.post(url_base+'personal/setForm',dataForm,function (data) {
            console.log(data);
            if(data === "ok"){
                status=true;
...
function  editar(id){
    ...
    var idd=parseInt(id);
    $.post(url_base+'personal/getData','id='+idd,function (data) {
            console.log(data);
...
function eliminar(id) {
    if(confirm('¿Esta seguro?')){
        var idd=parseInt(id);
        $.post(url_base+'personal/deleteData','id='+idd,function (data) {
            console.log(data);
