...
class Util
{
    ...
    public function __construct($config=null)
    {
        ...
        //$this->seeConf=include('filesfact/configfact.php');
        $this->seeConf=$config;
    }
     ...
     * @return See
     */
    public function getSee($seeConfig,$endpoint)
    {
        /*$see = new See();
...
//        $see->setCodeProvider(new XmlErrorCodeProvider());
         ...
         * Clave   = moddatos
         */
       /*  $see->setCredentials('10709295760ROBINFAC', 'robinFact1');

        $see->setCachePath(__DIR__ . '/../cache'); */

       // print_r($this->seeConf);exit();
       // $see=$this->seeConf;
...
HTML;
    ...
    private static function getParametersPdf()
    {
        ...
        $logo2 = file_get_contents(__DIR__.'/../resources/iconjkpng.png');
        return [
            'system' => [
                'logo' => $logo2,
                'hash' => ''
